...
INSERT INTO countries (
    country_id, country_iso, country_name, country_nicename, country_iso3,
    country_numcode, country_phonecode)
VALUES
(0, 'XX', 'UNKNOWN', 'Unknown', 'XXX', 0, 0),
...
"('bbq', 'bench', 'dog_toilet', 'dressing_room', 'drinking_water', 'give_box', 'lounge', 'mailroom', 'parcel_locker', 'shelter', 'shower', 'telephone', 'toilets', 'water_point', 'watering_place')"
"('sanitary_dump_station', 'recycling', 'waste_basket', 'waste_disposal', 'waste_transfer_station')"
"('animal_boarding', 'animal_breeding', 'animal_shelter', 'animal_training', 'baking_oven', 'clock', 'crematorium', 'dive_centre', 'funeral_hall', 'grave_yard', 'hunting_stand', 'internet_cafe', 'kitchen', 'kneipp_water_cure', 'lounger', 'marketplace', 'monastery', 'mortuary', 'photo_booth', 'place_of_mourning', 'place_of_worship', 'public_bath', 'public_building', 'refugee_site', 'vending_machine', 'user defined')"
)
